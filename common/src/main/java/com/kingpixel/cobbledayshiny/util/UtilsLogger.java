package com.kingpixel.cobbledayshiny.util;
...
public class UtilsLogger {
  ...
  public UtilsLogger() {
    logger = LogManager.getLogger(CobbleDayShiny.MOD_NAME);
  }
...
//		write(Level.FATAL, message);
  ...
  private void write(Level level, String message) {
    ...
    CompletableFuture<Boolean> future = Utils.writeFileAsync(CobbleDayShiny.PATH, "logs.txt", output);
